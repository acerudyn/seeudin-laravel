<div class='form-group <?php echo e($header_group_class); ?> <?php echo e(($errors->first($name))?"has-error":""); ?>' id='form-group-<?php echo e($name); ?>' style="<?php echo e(@$form['style']); ?>">
			...
			<?php if($value): ?>
				...
				<p><a class='btn btn-danger btn-delete btn-sm' onclick="if(!confirm('<?php echo e(trans("crudbooster.delete_title_confirm")); ?>')) return false" href='<?php echo e(url(CRUDBooster::mainpath("delete-image?image=".$value."&id=".$row->id."&column=".$name))); ?>'><i class='fa fa-ban'></i> <?php echo e(trans('crudbooster.text_delete')); ?> </a></p>
				<?php endif; ?>
			<?php endif; ?>	
			<?php if(!$value): ?>
