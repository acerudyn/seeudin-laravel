		...
		<div class="contact agileits-w3layouts" style="background: url(images/slide5.jpg) no-repeat center center fixed;
			...
			<div class="container">
				...
				<ul class="portfolio-filter text-center">
					...
					<li><a class="btn btn-default" href="/project/{{'6'}}" data-filter=".bootstrap">Bussines Card</a></li>
					<li><a class="btn btn-default" href="{{'/notfound'}}" data-filter=".html">Brand & Icons</a></li>
					<li><a class="btn btn-default" href="{{'/web'}}" data-filter=".wordpress">Web Development</a></li>
					<li><a class="btn btn-default" href="{{'/notfound'}}" data-filter=".bootstrap">Posters</a></li>
					<li><a class="btn btn-default" href="{{'/notfound'}}" data-filter=".bootstrap">Icons</a></li>
				</ul><!--/#portfolio-filter-->
