...
<!-- ========== Show Data From DB ================ -->
      ...
      <!-- banner -->
      @foreach ($show as $profil) @endforeach
				<div class="banner">
				...
				<div class="work agileits-w3layouts">
					<div class="container">
						...
						<div class="col-md-6 work-agile-right">
							...
							<div class="col-md-6 contact-wthree-right" style="padding: 0 5px 0 0; margin: 0px;">
								<a href="{{'/projects'}}" target="_blank"><input type="submit" value="VIEW MORE PROJECTS" ></a>
							</div>
			...
			<li class="agileits">
				...
				<div class="contact agileits-w3layouts">
                    ...
                    @if ($errors->has('name'))
                      <p style="color:red;">{{ $errors->first('name') }}</p>  <!-- Error validasi -->
                    @endif
                  ...
                  <input type="text" class="phone" name="phone" placeholder="Phone" value="{{ old('phone') }}" required>
                    @if ($errors->has('phone'))
                      <p style="color:red;">{{ $errors->first('phone') }}</p>  <!-- Error validasi -->
                    @endif
                  <textarea name="message" placeholder="Message" required>{{ old('message') }}</textarea>
                    @if ($errors->has('message'))
                      <p style="color:red;">{{ $errors->first('message') }}</p>  <!-- Error validasi -->
                    @endif
...
@include('Alerts::sweetalerts'); <!-- Sweet Alerts -->
