...
<html lang="en">
<head>
<title>Akhirudin | Projects</title>
		...
		<div class="contact agileits-w3layouts" style="background: url(images/slide5.jpg) no-repeat center center fixed;
			...
			<div class="container">
				...
				<ul class="portfolio-filter text-center">
					<li><a class="btn btn-default" href="<?php echo e('/projects'); ?>" data-filter="*">All Works</a></li>
					<li><a class="btn btn-default" href="/project/<?php echo e('6'); ?>" data-filter=".bootstrap">Bussines Card</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/notfound'); ?>" data-filter=".html">Brand & Icons</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/web'); ?>" data-filter=".wordpress">Web Development</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/notfound'); ?>" data-filter=".bootstrap">Posters</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/notfound'); ?>" data-filter=".bootstrap">Icons</a></li>
				</ul><!--/#portfolio-filter-->
