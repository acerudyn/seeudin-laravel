<?php namespace App\Http\Controllers;
	...
	class AdminPortfolioController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Category","name"=>"category","join"=>"category,name"];
			...
			$this->form[] = ['label'=>'Category','name'=>'category','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'category,alias'];
