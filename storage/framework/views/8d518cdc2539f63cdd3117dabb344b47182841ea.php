            ...
            <div class='col-sm-12'>
              ...
              <form method='get' action='' id='form-privilege'>
                ...
                <select class='form-control' onChange="$('#form-privilege').submit()" name='id_cms_privileges'>                  
                    <?php $__currentLoopData = $privileges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                      <option value='<?php echo e($p->id); ?>' <?php echo e(($id_cms_privileges == $p->id)?"selected":""); ?>><?php echo e($p->name); ?></option>
                  ...
                  <div class="panel-body clearfix">
                    <ul class='draggable-menu draggable-menu-active'>
                      <?php $__currentLoopData = $menu_active; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <li data-id='<?php echo e($menu->id); ?>' data-name='<?php echo e($menu->name); ?>'><div class='<?php echo e($menu->is_dashboard?"is-dashboard":""); ?>' title="<?php echo e($menu->is_dashboard?'This is setted as Dashboard':''); ?>">
