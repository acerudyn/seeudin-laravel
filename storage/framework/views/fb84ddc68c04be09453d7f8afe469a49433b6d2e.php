		...
		<div class="contact agileits-w3layouts" style="background: url(../images/slide5.jpg) no-repeat center center fixed;
			...
			<div class="container">
				...
				<ul class="portfolio-filter text-center">
					...
					<li><a class="btn btn-default" href="<?php echo e('/project/card'); ?>" data-filter=".bootstrap">Bussines Card</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/project/icon'); ?>" data-filter=".html">Brand & Icons</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/project/web'); ?>" data-filter=".wordpress">Web Development</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/project/poster'); ?>" data-filter=".bootstrap">Posters</a></li>
					<li><a class="btn btn-default" href="<?php echo e('/project/clothes'); ?>" data-filter=".bootstrap">Clothes</a></li>
				</ul><!--/#portfolio-filter-->
